...
# 
# Copyright (c) 2024-2025 Mahid Sheikh <mahid@standingpad.org>
# 
...
# Originally, this parser was under the BSD 3-Clause license. However, to make it
# more accesible, it has been relicensed to BSD 0-Clause, which is effectively
# public domain, without the issues of A. not being recognized in jurisdictions
# where public domain isn't a concept (*ahem* Europe) and B. requiring every
# contributor to submit a declaration deticating their changes to the public domain.
#
# - Mahid Sheikh
