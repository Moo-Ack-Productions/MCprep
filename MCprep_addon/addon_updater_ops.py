...
class addon_updater_install_popup(bpy.types.Operator):
	...
	def execute(self,context):
		...
		if updater.update_ready == True updater.manual_only==False:
		...
		elif updater.update_ready == True updater.manual_only==True:
			bpy.ops.wm.url_open(updater.website)
...
def register(bl_info):
	...
	# updater.website = "https://github.com/theduckcow/mcprep/releases/"
	...
	# has this set via UI properties
	...
	# Allow for manually installing only
	...
	updater.version_min_update = (3,0,0) # min install (>=) will install this and higher
	updater.version_max_update = None # max install (<) will install strictly anything lower
