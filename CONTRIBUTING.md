...
- Using AI tooling to describe changes in pull requests
- Reponding to reviews with comments generated by AI tooling
    - Using LLMs to translate is acceptable *if and only if* the wording of the translation is close to the original wording in one's native language
